...
- added sandbox doctor enforcement so token overlap, target overlap, and env-path masking now fail explicitly
...
- added a durable maintenance playbook for weekly, monthly, and quarterly upkeep
...
- the normal maintenance cadence now lives in `docs/maintenance-playbook.md`
