...
- current follow-up work is operational maturity:
  ...
  - address current operating data quality issues surfaced by clean refreshes: Execution WIP violations and the remaining unmapped external-signal projects
...
2. clean up operating data quality:
   reduce Execution WIP violations and map the remaining external-signal projects
