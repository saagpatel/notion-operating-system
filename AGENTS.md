...
- Saved view definitions live in `~/Projects/Notion/config/local-portfolio-views.json`.
...
- Phase-one control-tower rules and mutable phase state live in `~/Projects/Notion/config/local-portfolio-control-tower.json`.
