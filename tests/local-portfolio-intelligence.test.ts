...
describe("local portfolio intelligence", () => {
          ...
          views: [
            {
              ...
              configure: 'FILTER "Recommendation Lane" = "Resume"; SHOW "Name", "Recommendation Score"',
            },
          ],
        },
      ],
  ...
  test("builds a strong resume recommendation from structured support and execution context", () => {
    ...
    expect(renderRecommendationBriefSection({ context, recommendation })).toContain("## Recommendation Brief");
  });
    ...
    const candidates = generateCandidateLinkSuggestions({
      ...
      config: {
        ...
        commandCenter: {
          ...
          parentPageUrl: "https://www.notion.so/326c21f1caf0801484efce5bd9323449",
        },
        fieldOwnership: {
          manual: [],
          derived: [],
        ...
        queuePrecedence: ["Shipped", "Needs Review", "Needs Decision", "Worth Finishing", "Resume Now", "Cold Storage", "Watch"],
        viewIds: {},
        phase3Intelligence: {
          recommendationRuns: {
            name: "Recommendation Runs",
            databaseUrl: "https://www.notion.so/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
          ...
          linkSuggestions: {
            ...
            databaseUrl: "https://www.notion.so/cccccccccccccccccccccccccccccccc",
          ...
          confidenceThresholds: { highSupportDensity: 8, suggestionMinimum: 0.7 },
          reviewRequirements: { weeklyRequiresHumanReview: true },
          viewIds: { projects: {}, recommendationRuns: {}, linkSuggestions: {} },
          phaseMemory: {
  ...
  test("renders phase memory through phase five", () => {
    ...
    expect(markdown).toContain("Phase 3 gave us structured recommendation memory");
  });
});
...
function baseResearch(overrides: Partial<ResearchLibraryRecord> = {}): ResearchLibraryRecord {
  return {
...
function baseSkill(overrides: Partial<SkillLibraryRecord> = {}): SkillLibraryRecord {
  return {
...
function baseBuildSession(overrides: Partial<ControlTowerBuildSessionRecord> = {}): ControlTowerBuildSessionRecord {
  return {
...
function baseSuggestion(overrides: Partial<LinkSuggestionRecord> = {}): LinkSuggestionRecord {
  return {
